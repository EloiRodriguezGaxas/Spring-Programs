    ...
    public void configure(HttpSecurity http) throws Exception {
        http
        	.authorizeRequests()
				...
				.mvcMatchers("/api/users/{user}").hasRole("USER")
				.mvcMatchers("/api/users/{user}/notes").hasRole("USER")
				.mvcMatchers("/api/createuser").hasRole("USER")
				.mvcMatchers("/api/users/{user}").hasRole("USER")
				.mvcMatchers("/api/users/{user}/notes/{note}").hasRole("USER")
				.mvcMatchers("api/users/{user}/createNote").hasRole("USER")
